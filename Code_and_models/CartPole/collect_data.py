# -*- coding: utf-8 -*-
"""
Created on Sun Mar 13 19:33:52 2022
...
SAVE_DATA = True # Decide to save memory buffer
...
model = torch.load('model_TRA190.93.pt')
print(model)
...
torch.save(memory.episode, 'ReplayMemor_Validation_random_400_episode.pt')

data = torch.load('ReplayMemory_w_random_400_episode.pt')    
